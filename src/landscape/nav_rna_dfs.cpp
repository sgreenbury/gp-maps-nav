...
ABSL_FLAG(bool, load_genos, true,
...
int main(int argc, char *argv[]) {
  std::string message =
      "Fitness landscape navigability for algorithmic folding of fRNA.";
